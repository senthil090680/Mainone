...
jQuery.fn.slideViewerPro = function(settings) {
	...
	return this.each(function(){
		...
		*/
		...
		var pictWidth = (wWidth*73/100); 
		var pictHeight = (wHeight*79/100);
		var pictEls = container.find("li").size();
		$(".alb-img").css("height", (pictHeight) + "px");
		$(".alb-img").css("width", (pictWidth) + "px");
    ...
    .wrap(jQuery("<div id= album_list' style='width:"+ pictWidth +"px; overflow: hidden; position: relative; top: 0; left: 0; margin : 2.5%;'>"));
